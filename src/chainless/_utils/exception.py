...
class ChainlessError(Exception):
    """Base exception for all Chainless-related errors."""
...
class AgentExecutionError(ChainlessError):
    """Raised when agent execution fails."""
    pass

class ModelConnectionError(ChainlessError):
    """Raised when there's an error connecting to the model."""
    pass

class TaskProcessingError(ChainlessError):
    """Raised when task processing fails."""
    pass

class ConfigurationError(ChainlessError):
    """Raised when there's a configuration error."""
    pass

class RetryExhaustedError(ChainlessError):
