...
class ModelNames(Enum):
    ...
    # Claude / Anthropic
    CLAUDE_3_5_SONNET = "claude/claude-3-5-sonnet"
    CLAUDE_3_7_SONNET = "claude/claude-3-7-sonnet"
    BEDROCK_CLAUDE_3_5_SONNET = "bedrock/claude-3-5-sonnet"

    # Gemini
    GEMINI_GEMINI_2_0_FLASH = "gemini/gemini-2.0-flash"
    GEMINI_GEMINI_1_5_PRO = "gemini/gemini-1.5-pro"
    GEMINI_GEMINI_1_5_FLASH = "gemini/gemini-1.5-flash"

    # Ollama
    OLLAMA_LLAMA3_2 = "ollama/llama3.2"
    OLLAMA_LLAMA3_1_70B = "ollama/llama3.1:70b"
    OLLAMA_LLAMA3_1 = "ollama/llama3.1"
    OLLAMA_LLAMA3_3 = "ollama/llama3.3"
    ...
    OPENROUTER_META_LLAMA_3_1_8B_INSTRUCT = "openrouter/meta-llama/llama-3.1-8b-instruct"
    OPENROUTER_GOOGLE_GEMINI_PRO = "openrouter/google/gemini-pro"
    OPENROUTER_CUSTOM = "openrouter/<provider>/<model>"
